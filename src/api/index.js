...
export  default {
   ...
   * */
  startCrawler(par) {
    return axios.get(URL_PREFIX+'/startCrawler?'+par)
  },
  novelList(){
     return axios.get(URL_PREFIX)
  },
   novelListApply(){
     return axios.get(URL_PREFIX+'?statusType=1')
  },
  addNovel(par){
  ...
  register(par){
    return axios.post(URL_PREFIX+'/register',par)
  },
  login(par){
    return axios.post(URL_PREFIX+'/login',par)
  },
  loginout(){
    return axios.post(URL_PREFIX+'/loginout')
  }
